        ...
        <>
          ...
          >
            <header className="flex items-center justify-between border-b border-border px-6 py-4">
              <div>
                <span className="text-[10px] uppercase tracking-widest text-muted-foreground">Your cart</span>
            ...
            {items.length > 0 && (
              <footer className="border-t border-border px-6 py-4">
                ...
                <button
                  onClick={clear}
                  className="mt-2 w-full rounded-full py-2 text-[11px] uppercase tracking-widest text-muted-foreground hover:text-destructive"
                >
                  Clear cart
                </button>
              </footer>
